<template>
  <div>
    <div
      class="bg-custom-blue custom-width custom-height flex items-center gap-0"
    >
      <div class="flex flex-1 items-center justify-between px-4">
        <div class="text-black custom-typography custom-typography">
          <h1 class="text-lg font-bold">Frontend Development Challenge #1</h1>
        </div>
        <div
